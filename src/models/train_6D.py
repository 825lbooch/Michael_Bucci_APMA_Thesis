"""
Fusion DeepONet Training for 6D Antenna S11 Prediction

Run from repo root: python src/models/train_6D.py

Input:  data/processed/*.npz
Output: experiments/exp_6D_full/models/
"""
...
print("=" * 60)
print("Fusion DeepONet Training - 6D Antenna")
print("=" * 60)
