"""
Baseline DeepONet Training on 700 Samples

No residual/analytical model - pure data-driven learning.
For comparison against residual learning approach.

Run from repo root: python src/models/train_baseline_700.py
"""
...
DATA_DIR = os.path.join(REPO_ROOT, 'data', 'processed_700')
MODEL_DIR = os.path.join(REPO_ROOT, 'experiments', 'exp_baseline_700', 'models')
...
print("=" * 60)
print("Baseline DeepONet Training - 700 Samples")
print("=" * 60)
...
try:
    ...
    print("Error: Dataset files not found in data/processed_700/")
    sys.exit(1)
...
print("\n" + "=" * 60)
print("BASELINE TRAINING COMPLETE (700 samples)")
print("=" * 60)
